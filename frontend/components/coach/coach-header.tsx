...
import type { CoachContext } from "@/features/coach/types/coach"

export function CoachHeader({ context }: { context: CoachContext | null }) {
  return (
